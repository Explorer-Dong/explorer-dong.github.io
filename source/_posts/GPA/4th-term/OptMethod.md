...
#### 2.3.2 对偶定理 :star: TODO



#### 2.3.3 对偶单纯形法 :star: TODO
...
对于多变量最优化问题中，我们需要迭代计算每一个过程的解 x_k。一般的解的迭代格式为：
$$
...
本目介绍的两种方法都是用来缩小线性搜索问题的区间的，并且上述两种方法都**仅仅利用函数值**而没有利用导数值，这种缩小区间的方法一般被称为直接法。
...
于是问题的关键就在于如何取点 $x_1$ 和 $x_2$，下面开始介绍三种取点方法。
