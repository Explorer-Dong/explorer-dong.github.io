...
前面学习了很多操作系统调度 CPU、内存等部件进行计算的过程，现在我们更进一步的学习操作系统如何获取需要计算的数据以及如何将数据呈现给人类进行可视化。主要介绍磁盘设备。

#### 磁盘

![磁盘结构示意图](https://dwj-oss.oss-cn-nanjing.aliyuncs.com/images/202412130825688.png)
...
为了更进一步的理解文件打开时系统都做了些什么，下面基于类 Unix 系统的设计理念详细介绍：
