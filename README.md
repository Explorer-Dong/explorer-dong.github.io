<div align="center"><img src="https://dwj-oss.oss-cn-nanjing.aliyuncs.com/images/20250321124008628.png" alt="site logo" style="zoom:67%;" /></div>

本网站以「AI / CS 学科笔记」与「开发技术文章」为基础，旨在构建一个 **开放知识社群 (Open Wiki Community)**。内容按照 Markdown 格式撰写，站点采用 MkDocs 框架编译，云端基于 GitHub Pages 与 Aliyun Server 双平台部署。如果您觉得内容不错，欢迎⭐。访问链接：
